...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[B,LAI,LAIdead,RBi] = Grass_Cut_Grazing(B,LAI,LAIdead,dtd,aSE,Sl,mSl,Date,cutDate,LAI_cut)  
 
% jDay, jDay_cut -> Date, Cut Date
%%%% INPUT
Btm1 = B; 
%%%%%%%%%% Grass Cut and Grazing
% if (aSE==2)  &&  not(isempty(intersect(jDay,jDay_cut)))

if (aSE==2)  &&  any(ismember( round(cutDate) , round(Date)))
