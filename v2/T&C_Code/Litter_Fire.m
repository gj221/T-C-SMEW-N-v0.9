...
%%%%%%%%
B(60)= B(60)+ (B(56) + B(57))*fire_eff; %%% Ca-burned 
B(56)=B(56)*(1-fire_eff); 
B(57)=B(57)*(1-fire_eff);
%%%%%%%%
B(68)= B(68)+ (B(64) + B(65))*fire_eff; %%% Mg-burned 
B(64)=B(64)*(1-fire_eff); 
B(65)=B(65)*(1-fire_eff);
%%%%%%%%
B(76)= B(76)+ (B(72) + B(73))*fire_eff; %%% Mg-burned 
B(72)=B(72)*(1-fire_eff); 
B(73)=B(73)*(1-fire_eff);
