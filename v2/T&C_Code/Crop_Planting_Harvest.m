...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[B,Nreserve,Preserve,Kreserve,Careserve,Mgreserve,Sireserve, RB,LAI,LAIdead,ManI,PHE_S,dflo,AgeL,AgeDL] ...
    = Crop_Planting_Harvest(B,Nreserve,Preserve,Kreserve,Careserve,Mgreserve,Sireserve,RBtm1,dtd,LAI,LAIdead,PHE_S,dflo,AgeL,AgeDL,Datam,Mpar)
%%%%%%
...
if  sum(abs(DD-Date_sowing)<=0.49)>=1
    ...
    Careserve = Mpar.NPK_res_ini(4);
    Mgreserve = Mpar.NPK_res_ini(5);
    Sireserve = Mpar.NPK_res_ini(6);
